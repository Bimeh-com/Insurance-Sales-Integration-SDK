...
{
    public class PersonalAccidentIntegrationTests
    {
        ...
        [Fact]
        public async Task PersonalAccident_RunAsync_ShouldReturnTrue()
        {
            var client = CreateClient();
            await AuthenticateAsync(client);
            var result = await new PersonalAccidentInsuranceSamples(client).RunAsync();
